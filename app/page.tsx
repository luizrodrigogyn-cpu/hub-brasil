            ...
            <form onSubmit={register}>
              ...
              {registrationRole === "client" ? <>
                ...
                <div className={`supplier-registration-step${supplierRegistrationStep === 2 ? " active" : ""}`} aria-hidden={supplierRegistrationStep !== 2}>
                  ...
                  <p className="progressive-note"><strong>O restante fica para depois.</strong> Descrição, CNPJ, site, regiões atendidas e produtos serão adicionados um passo por vez no cockpit.</p>
