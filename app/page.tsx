...
export default function Home() {
  ...
  const supplierInsights = [
    pendingSupplierOpportunities[0] ? {
      id: `insight-match-${pendingSupplierOpportunities[0].id}`,
      label: "Boa oportunidade para você",
      title: `${pendingSupplierOpportunities[0].match.score}% compatível com sua empresa`,
      reason: pendingSupplierOpportunities[0].match.reasons.length ? `Porque ${pendingSupplierOpportunities[0].match.reasons.join(", ")}.` : "Porque a categoria da demanda combina com o seu perfil comercial.",
      action: "Ver oportunidade",
      kind: "opportunity",
      opportunity: pendingSupplierOpportunities[0],
    } : null,
    uncoveredCategory ? {
