...
export default async function AdminPage() {
  ...
  if (!isHubAdmin(user)) return <main className="admin-page"><section className="admin-content"><div className="admin-empty"><strong>Acesso restrito</strong><p>Esta área é exclusiva para gestores autorizados do Hub Brasil e exige autenticação em dois fatores.</p><a className="primary" href="/">Voltar ao site</a></div></section></main>;
