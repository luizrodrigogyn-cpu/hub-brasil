...
export async function POST(request: Request) {
  try {
    ...
    if (role === "supplier" && (!company || !category || !city || !state || !cnpj)) return Response.json({ error: "Fornecedor deve informar empresa, CNPJ, categoria, cidade e estado." }, { status: 400 });
